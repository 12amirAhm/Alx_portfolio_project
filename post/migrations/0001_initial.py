    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Additional_Requirments', models.TextField(blank=True, null=True)),
                ('How_to_Apply', models.TextField(blank=True, null=True)),
                ('Dead_Line', models.CharField(max_length=200)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('JobTitle', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='post.jobtitle')),
                ('Work_Place', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='post.workplace')),
